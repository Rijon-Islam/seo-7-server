        ...
        app.put("/update-experiences/:id", async (req, res) => {
            ...
            const updatedDoc = {
                $set: {
                    ...
                    sliderImage: sectionExperience.sliderImage,
                    slidericon: sectionExperience.slidericon,
                    sliderHeading: sectionExperience.sliderHeading,
                    websiteText: sectionExperience.websiteText,
                    websiteURL: sectionExperience.websiteURL,
        ...
        app.put("/update-teamitems/:id", async (req, res) => {
            ...
            const updatedDoc = {
                $set: {
                    ...
                    fbLink: memberSection.fbLink,
                    insLink: memberSection.insLink,
                    liLink: memberSection.liLink,
            ...
            app.put("/faq/:id", async (req, res) => {
                ...
                const updatedDoc = {
                    $set: {
                        ...
                        faqDetails: faqSection.faqDetails,
                        faqImage: faqSection.faqImage,
        ...
        app.put("/update-banner/:id", async (req, res) => {
            ...
            const updatedDoc = {
                $set: {
                    ...
                    videoLink: bannerSection.videoLink,
        ...
        app.put("/update-actions/:id", async (req, res) => {
            ...
            const updatedDoc = {
                $set: {
                    ...
                    buttonText: actionSection.buttonText,
                    buttonLink: actionSection.buttonLink,
        ...
        app.put("/update-counters/:id", async (req, res) => {
            ...
            const updatedDoc = {
                $set: {
                    ...
                    counterImage: counterSection.counterImage,
...
app.listen(port, () => {
    console.log('Good Job, SEO-7  Server is Live Now', port);
});